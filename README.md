...
- The analysis starts from:
  - call/sequence tables exported from **Avisoft-SASLab Pro** (not included),
...
Again, this is one row per comparison × metric, to be combined with the spectral distances in the next step.
...
- Scale distances:
  - distance scaled to 0–1 within each metric (for the LMMs reported in the manuscript), and  
